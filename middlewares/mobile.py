...
from gateway.utils import get_response_with_auth_headers
...
class AuthMiddleware(BaseHTTPMiddleware):
    async def dispatch(self, request: Request, call_next):
        ...
        request = await self.check_auth_headers(request=request)
    ...
    @classmethod
    async def check_auth_headers(cls, request: Request):
